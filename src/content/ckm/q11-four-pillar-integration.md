...
### 能說到哪裡
CONFIDENCE 顯示，在 **T2D + CKD + albuminuria + 已使用 RASi** 的人群中，
**初始合併 finerenone + empagliflozin** 在 180 天的 **UACR 降幅** 優於任一單藥。
...
主要終點為 **total worsening HF events + cardiovascular death**，結果：
