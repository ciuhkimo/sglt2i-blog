...
description: "Perioperative SGLT2i 停藥時機，涵蓋北美與英國停藥天數差異、eDKA 風險監測與緊急手術處置。"
tags:
  - SGLT2i
  - decision-note
  - holding
...
- Canagliflozin、Dapagliflozin、Empagliflozin：術前 **≥3 天**停藥
- Ertugliflozin（半衰期最長）：術前 **≥4 天**停藥
- 停藥期間維持適當水分補充，避免脫水
...
### 不建議做法
- **不建議**無論手術大小一律忽略停藥（eDKA 死亡率 1-10%）
- **不建議**僅以血糖作為 eDKA 篩查指標（euglycemic DKA 血糖可正常）
- **不建議**未評估個別風險即一律最長停藥（損失心腎保護效益）
...
| 版本 | 日期 | 主要變更 |
|------|------|---------|
| v1.0 | 2026-04-04 | 第三輪人工校稿（Q16校稿）：CCJM row「一致建議 SGLT2i 停藥 ≥3 天」→「國際建議存在異質性：北美主流（FDA/ADA/ACC-AHA）多採 3–4 天；英國/部分國際共識（CPOC、Anaesthesia 2025）多採 day before + day of procedure」 |
| v0.6 | 2026-04-04 | 第二輪人工校稿（Q16校稿）：(1) El-Boghdadly Anaesthesia 2025 row 修正：停藥建議改為「omit on the day before and the day of a procedure」（⚠️ 非≥3天），補入住院重啟條件（eating/drinking normally + capillary ketones <0.6 mmol/L）；Clinical Decision 中 GLP-1RA 並用停藥時程同步更新；(2) NCT06838507 改寫為 multicentre prospective observational cohort（not yet recruiting），明確非 continue-vs-hold 比較 RCT；(3) Uncertainty「各國指南達成共識（≥3天）」→「主流北美傾向 3–4 天；英國/國際傾向 day before + day of procedure；存在明顯異質性」；(4) Metadata Evidence Sources count/LOE 更新（8 筆，LOE A:2 / B:4 / C:2 + Anaesthesia 共識）；Guideline Concordance 修正反映北美 vs 英國差異 |
| v0.5 | 2026-04-04 | 第一輪人工校稿（Q16校稿）：(1) ACC/AHA 2024 Guideline table strength 修正：Class IIa → **Class I**，補入適用族群「HF and/or diabetes」；(2) PMC 11947582（2025 BJA）row 重寫：移除「HR 2.40」歸因，反映真實研究結果（加權調整後未顯示 30 天不良事件增加，甚至有較低 mortality 訊號）；說明 HR 2.40 出自 2026 Frontiers review 作者延伸論述；(3) PMC 12932149 年份修正 2025→2026（Frontiers in Endocrinology review），LOE B→C，加 ⚠️ 標注為 expert synthesis；(4) CCJM row LOE B→C，加 secondary guideline comparison 標注；更新「缺乏指引」措辭；(5) Why This Matters 移除「HR 2.40」；(6) Uncertainty「缺乏指引」→「直接證據有限，但已有 guideline/consensus 納入管理建議」 |
| v0.4 | 2026-03-25 | AI 草稿更新（v0.4） |

---

## 相關筆記
[Q09 Surgery Fasting Hold](/notes/q09-surgery-fasting-hold)：聚焦禁食/sick day 的急性停藥決策（與 Q16 有重疊）
[Q18 Postop Restart](/notes/q18-postop-restart)：術後何時重啟 SGLT2i 的完整流程
