...
quick_answer: "啟用前應評估血壓、姿態性低血壓及體液徵象；高風險者（高齡、合併利尿劑）可先減量利尿劑再啟用。"
tags:
  - SGLT2i
  - decision-note
  - monitoring
...
1. **第 1 週**：啟用 SGLT2i 標準起始劑量；若進行利尿劑調整，先 <b>減少</b> 利尿劑（不是增加）
2. **第 2-4 週**：追蹤血壓、腎功能、電解質、症狀；評估是否需進一步調整
3. **第 5-12 週**：如果 BP 與腎功能穩定，可根據臨床需要微調利尿劑

#### 原則 3：**高風險亞群的個別化評估**

針對以下患者，啟用 SGLT2i 時應**個別化評估**是否需要提前調整利尿劑，無固定減量比例可普遍套用：
- 年齡 ≥75 歲（跌倒風險高）
...
> **重要框架**：KDIGO 2024 明確指出，SGLT2i 啟用本身通常**不需要改變 CKD 的常規監測頻率**。下列時程為**較高風險患者**（eGFR 接近下限、高劑量利尿劑、prior AKI、低血壓傾向）的 **local practical approach**，非全體患者的 guideline mandate。
...
| **計畫性重大手術 / 長時間禁食** | 禁食期體液攝取不足；euglycemic DKA 風險 | 依個別藥品 label：dapagliflozin / empagliflozin / canagliflozin 為**至少 3 天前**停用；ertugliflozin 為**至少 4 天前**；實際執行依各院 perioperative protocol（見 Q09）；恢復進食且臨床穩定後再評估重啟 |
...
| 版本 | 日期 | 主要變更 |
|------|------|---------|
| v0.1 | 2026-03-17 | 初稿，AI 自動生成，待人工審閱 |
| v0.2 | 2026-03-22 | 第一輪事實校正：(1) Guideline attribution 修正：volume/diuretic guidance → KDIGO 2022 Practice Point 1.3.4；KDIGO 2024 主要涵蓋 monitoring frequency 與 sick-day rule；ADA 2025 → 2026；(2) Meta-analysis 年齡 subgroup 降階：年齡效應未達明確統計顯著差異，保守解讀；(3) BUN/Cr、USG cut-off 降為輔助指標，附 CKD/diuretic 干擾說明；(4) 風險分層 eGFR staging 修正：eGFR <15 → G5（非 G4）；eGFR 15-30 標示修正；(5) 利尿劑「30-50% 預防性減量」移除固定比例，改為個別化 + DAPA-CKD 證據說明；(6) K>6 暫停 SGLT2i 重新框架：SGLT2i 非主因，重點在 RAASi/腎功能管理；(7) 術前停藥改為「至少 3 天前」（依 dapagliflozin Farxiga label）；(8) Practical Prescribing 來源更正：Kidney Int Rep 2022，非 AJKD |
| v0.3 | 2026-03-22 | 第二輪事實校正：(1) 術前停藥時間：補入 ertugliflozin 4 天，dapagliflozin/empagliflozin/canagliflozin 3 天；(2) K>6 hold row 重新框架；(3) Creatinine 閾值修正；(4) FDA row 收斂；(5) Cirrhosis/ascites 改為非 blanket contraindication；(6) 監測時程加框架說明 |
| v0.3.1 | 2026-03-22 | 補入 meta-analysis 具體 subgroup RRs |
| v0.4 | 2026-03-22 | 第三輪精修：風險分層 cirrhosis/ascites、eGFR 20–30 限定語、重啟條件移除固定時間窗 |
| v0.5 | 2026-03-22 | 第四輪精修：開頭機轉句補入 TGF；急性腹瀉/嘔吐改為事件導向；K>6 與肝硬化移至「非自動停藥觸發情境」 |
| v1.0 | 2026-03-22 | 第五輪精修：eGFR 計算公式修正；風險分層 SBP/利尿劑劑量標明 heuristic |
| v1.1 | 2026-03-23 | 自動化更新：整入 Choi et al. 2025 (JCPT) Hct/Hb meta-analysis；Evidence Sources 更新至 5 項 |
