...
4. **AKI 後 SGLT2i 重啟率過低**：現實臨床中僅 30–50% 患者於 AKI 後成功重啟，大多數停藥係非必要
...
| SGLT2i During AKI — Frontiers Pharmacology | 2024 | CKD/DM/HF 住院 AKI 患者 | 研究主題為 AKI **住院期間**使用 SGLT2i 與 MAKE10 / MAKE30–90 之關聯；結果顯示短中期 MAKE 並無顯著增加，部分分析甚至有較低 mortality 訊號（⚠️ 此研究並非 early-vs-delayed restart 的直接比較；「延遲重啟與較差預後相關」不是本研究的主結論，應避免此歸因） | B |
...
### 不建議做法
- **不建議**無限期停用 SGLT2i（除非有明確禁忌症）
- **不建議**在腎功能尚未穩定時即重啟（AKI 仍進展中）
- **不建議**僅憑「一次 AKI」病史永久停藥，需重新評估當時 AKI 原因
...
[Q14 Acute Illness Hold](/notes/q14-acute-illness-hold)：急性疾病期間的 sick day rule
