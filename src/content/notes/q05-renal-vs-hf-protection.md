...
quick_answer: "SGLT2i 心臟與腎臟保護同步發生、機轉互補，CKD 合併 HF 患者為最高獲益族群，應優先啟用。"
tags:
  - SGLT2i
  - decision-note
  - integration
...
理解 SGLT2 抑制劑的**心腎雙重保護機制**及其**臨床證據層級**，有助於：
1. 精確溝通治療目標，提高患者依從性
...
|---------|------|---------|---------|---------|----------|
| **DAPA-CKD**（PMID 32970396） | 2020 | CKD ± DM | primary composite HR 0.61 (P<0.001)（sustained ≥50% eGFR decline、ESKD、kidney or CV death）<br/>CV death/HF hosp HR 0.71 | A | ✅ 雙重 |
...
#### 5. 極端情況處理
- **eGFR 20-25 的邊界患者**: KDIGO 下限為 eGFR ≥20，並未對 20–25 這一區間給出另一個明文 threshold；是否於此區間啟動屬於**臨床個案判斷**（考量整體獲益/風險），非 guideline 明文推薦。需密切監測腎功能與電解質
...
- **事實**: 許多 SGLT2i 的益處在於**減緩長期衰退**，而非急性改善
...
4. **滲透性利尿 + 鈉利尿** → 體液容積↓，血壓↓（收縮壓 -3～-5 mmHg）
5. **心臟前/後負荷↓** → 心輸出量改善，能量耗竭減少

#### 代謝與分子改變 (Metabolic & Molecular) - 深層
6. **代謝轉變**: 葡萄糖依賴 → 酮體利用（thrifty substrate hypothesis）
7. **線粒體功能**: AMPK/Sirtuin 軸激活 → 自噬↑、線粒體生物發生↑
8. **發炎與衰老**: 細胞因子↓（TNF-α, IL-6）、衰老相關標誌物↓
...
- **臨床實踐**: 目前傾向認為 class effect。Canagliflozin 的截肢風險：FDA 2020 已移除 boxed warning，但截肢風險仍**明確保留於 Warnings and Precautions**（非移除），FDA 亦要求持續足部監測並在選藥時考慮 predispose to amputation 的 risk factors。有足壞疽或周邊動脈疾病史的高危患者，臨床上傾向選用 dapagliflozin 或 empagliflozin（**pragmatic clinical preference**；非 FDA/KDIGO 明文規定須換藥）
...
- **鉀離子機制澄清**：SGLT2i 本身並非典型「保鉀藥」；individual participant meta-analysis 與 EMPEROR-pooled 分析反而顯示 SGLT2i 可**降低** serious hyperkalemia 風險。高鉀的主要風險來自 finerenone / RAS blockade，而非 SGLT2i 本身。
...
- [x] **ADA 2026 指南**：已發表，已納入本版（T2D+CKD/HF 語境）
- [x] **KDIGO 2024**：已核對，本版對照 KDIGO 2024 CKD Update
...
SGLT2 抑制劑同時提供**腎保護與心臟保護**，兩者並非二擇一。從分子機制、臨床試驗到國際指南，一致証實：
...
| v1.1 | 2026-03-21 | 第一輪事實校正：(1) KDIGO 2024 分層修正，移除「所有 CKD stage 3–5 均 1A」，改為 1A（eGFR ≥20 + UACR ≥200 或 HF）/ 2B（eGFR 20–45 + UACR <200），補入續用規則；(2) ADA 更新至 2026，限縮為 T2D+CKD/HF 語境；(3) ESC 拆分為 2021 HFrEF（原始）+ 2023 focused update（HFmrEF/HFpEF 升至 Class IA）；(4) EMPA-KIDNEY 移除來源不明的「HR 0.81」，保留 primary outcome HR 0.72；(5) HF renal endpoints 個別化：DAPA-HF 腎複合終點 HR 0.71 未顯著；EMPEROR-Reduced HR 0.50 顯著；DELIVER 腎複合 HR 1.08 未顯著；HFpEF 主要效益為 HF outcomes；(6) DAPA-HF eGFR 門檻：排除 eGFR <30，非「無下限限制」；(7) 四樂制標示限縮為 HFrEF 語境；(8) Canagliflozin 截肢風險：FDA 2020 已移除 boxed warning，現列於 Warnings and Precautions | Chang（腎臟科）|
| v1.2 | 2026-03-21 | 第二輪精修：(1) 試驗年份：EMPA-KIDNEY 改為 2022（主要結果年份），EMPEROR-Preserved 改為 2021；(2) DAPA-CKD HF 盛行率：改為約 11%（非 23%）；移除「純 CKD 無心衰竭診斷」錯誤描述，改為「CKD trial，僅排除 NYHA class IV HF」；(3) CV benefit wording：移除「預防心肌梗塞與中風」，改為「降低心衰竭住院與部分心血管風險」（SGLT2i 最穩定效益為 HF hospitalization/CV death）；(4) 決策樹適用範圍：按 KDIGO 2024 分層（ACR ≥200 或 HF → 1A；20–45 + ACR <200 → 2B；eGFR <20 新起始 → 證據缺口）；(5) 監測段落：改為依臨床風險調整，非固定時程 mandate；LVEF 改善 5–10% / NYHA 0–1 級移除，改為 KCCQ/症狀/HF events 為目標；(6) Finerenone：補入 CONFIDENCE trial（albuminuria endpoint）；澄清 SGLT2i 本身降低高鉀血症風險，不是保鉀藥；(7) DKA：移除「~1–2/10,000 patient-years」精確數字，改為風險情境描述 + sick-day rule；(8) 版本時序：修正「v0.1 當前」與「待追蹤 ADA 2026/KDIGO 2025」等過時描述 | Chang（腎臟科）|
| v1.3 | 2026-03-21 | 第三輪校正：(1) KDIGO guideline HF 欄：移除「HFrEF+HFpEF 1A」，改為 KDIGO CKD guideline 脈絡對 CKD+HF（不論 albuminuria）→ 1A；HF phenotype-specific Class IA 由 ESC 承接；(2) Early HF initiation：改為「hemodynamically stable 後早期啟動」，補入 EMPULSE evidence 與 ESC 2023 出院前快速啟動；(3) eGFR <20：明確區分 continuation logic（KDIGO 支持）vs 新起始（尚無充分 RCT 直接腎保護依據）；(4) HFpEF 腎保護：移除「腎保護效果相近」，改為「renal hard endpoint benefit 未建立穩定保護（DELIVER HR 1.08 NS；EMPEROR-Preserved 主效益為 HF outcomes）」；(5) Executive Summary：數字改為 trial-specific（CREDENCE HR 0.70 / DAPA-CKD HR 0.61 / EMPA-KIDNEY HR 0.72，RRR ~28–39%）；心臟效益明確為 HF hospitalization/CV death，非 MI/stroke | Chang（腎臟科）|
| v1.4 | 2026-03-21 | 第四輪校正：(1) 臨床決策框架「極端情況」finerenone 條目：移除「尚無大型 RCT」，改為正確描述 CONFIDENCE 試驗（randomized，180 天，UACR 為 primary endpoint；hard outcome 尚在累積）；澄清鉀監測重點在 finerenone/RAS 而非 SGLT2i | Chang（腎臟科）|
| v1.5 | 2026-03-22 | 第五輪精修（wording precision）：(1)「非選擇性」移除，補入 CKD/HF 不等同框架；(2) eGFR 20–25 啟動標為臨床個案判斷；(3) Finerenone 適用族群補入 ADA 2026 具體條件（T2D、UACR ≥100、eGFR 30–90、已在 RAS inhibitor）；(4) 截肢高危換藥標為 pragmatic approach，FDA 未明文規定 | Chang（腎臟科）|
| v1.6 | 2026-04-01 | 第六輪校正（Q5 peer-review 第一輪）：(1) KDIGO 2024 表格補入 Rec 3.7.1（T2D + CKD + eGFR ≥20 → 1A）作為最強適應症入口；(2) DAPA-CKD primary composite HR 0.61 補入 endpoint 定義（sustained ≥50% eGFR decline、ESKD、kidney or CV death）；(3) EMPEROR-Preserved renal outcome 改為「renal hard endpoint benefit 尚未一致建立，主要效益為 HF outcomes」；(4) CONFIDENCE 升級為「NEJM 2025 已發表 randomized trial」，hard outcome 尚未定論；(5) Canagliflozin 截肢風險：補入 FDA 2020 移除 boxed warning 但仍保留 Warnings and Precautions，改用 pragmatic clinical preference | Chang（腎臟科）|
| v1.7 | 2026-04-01 | 第七輪校正（Q5 peer-review 第二輪）：ESC 2021/2023 guideline row 補入原始 journal 引用（Eur Heart J 2021;42:3599–3726；Eur Heart J 2023;44:3627–3639），明確標注 HFmrEF/HFpEF 升等的 trial basis（DELIVER/EMPEROR-Preserved）；其餘主幹（DAPA-CKD primary composite wording、HFpEF 腎結局保守措辭）reviewer 確認已在 v1.6 到位 | Chang（腎臟科）|
| v1.9 | 2026-04-04 | 第九輪校正（Q5 peer-review 第四輪）：(1) EMPEROR-Preserved PMID 錯誤修正：34634179 → 34449189（"Empagliflozin in Heart Failure with a Preserved Ejection Fraction", NEJM 2021）；(2) Executive Summary 「腎保護依 phenotype 而異（HFrEF > HFpEF）」改為保守推論句：「HFpEF/HFmrEF 已確立效益以 HF outcomes 為主；renal hard endpoint benefit 不如 HFrEF/CKD trials 一致」，並加 ⚠️ 標注為 cross-trial 推論而非 head-to-head RCT 結論 |
| v1.8 | 2026-04-04 | 第八輪校正（Q5 peer-review 第三輪，定稿整理）：(1)「心腸超聲波」→「心臟超聲波」（錯字）；(2) v1.6/v1.7 補入正式修訂歷史表格；(3) 機制「上游→下游」框架加 ⚠️（機制整合推論，非 RCT 直接結論）；(4) Executive Summary「HFrEF > HFpEF 腎保護」加 ⚠️（cross-trial 推論，非 head-to-head 比較）；(5) Landmark trials table 補入 PMID：DAPA-CKD 32970396、EMPA-KIDNEY 36331190、DAPA-HF 31535829、EMPEROR-Reduced 32865377、DELIVER 35987019、EMPEROR-Preserved 34634179；(6) Executive Summary CREDENCE 補 PMID 30990260；(7) CONFIDENCE 兩處補 PMID 40470996 + NCT05254002，並補入聯合組具體 UACR 降幅數字（vs finerenone -29%；vs empagliflozin -32%） | Chang（腎臟科）|
