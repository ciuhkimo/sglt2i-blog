...
| v0.2 | 2026-03-23 | 第一輪人工審閱：Why This Matters 修正；Frontiers meta-analysis 年份修正；Solinsky 降級；KDIGO row 改寫；ADA 年份修正；高風險族群 cutoff 修正；canagliflozin 風險降級；進行中研究補入 ClinicalTrials registry |
| v0.3 | 2026-03-23 | 第二輪人工審閱：ESC 2023 row 降級；ADA 2026 row 精確化；患者教育手術停藥修正；ClinicalTrials.gov 狀態更新；Uncertainty 加入 perioperative data 不一致 |
| v1.0 | 2026-03-23 | 第三輪 + 第四輪人工審閱／定稿：Lin→Liu 修正；ESC row 詮釋句移至 Authority 欄；Sick day rules 收斂為具體情境；ClinicalTrials.gov 補入 perioperative 方向；non-diabetic CKD 敘述修正 |
