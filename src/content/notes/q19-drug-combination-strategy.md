...
- **不建議**因「已有 ACEi/ARB」而推遲 SGLT2i——兩者機轉不重疊，應合用
...
- **不建議**在血鉀 > 5.0 mmol/L 時常規啟動 finerenone（先控制高血鉀再評估）
...
|------|------|---------|
| v1.0 | 2026-04-04 | 定稿 |
| v0.7 | 2026-04-04 | 第三輪人工校稿（Q19校稿）：(1) 待追蹤項目刪除「CONFIDENCE-2 結果（預計 2026–2027）」（ClinicalTrials.gov 無法核實已命名 Phase 3 trial）；改為「待 FIND-CKD 正式發表」與「待 CONFIDENCE 後續 hard-outcome trial 正式註冊後追蹤」；Next Review Date 同步更新；(2) FLOW primary endpoint wording 補全：改為「kidney failure、persistent ≥50% eGFR reduction、kidney death、或 CV death」，與 FLOW 正式 endpoint 定義一致；(3) Metadata Evidence Sources 重新清點為 5 篇（LOE A: 3、LOE B: 2）；Guideline Concordance 統一為 ADA 2026（移除舊版 ADA 2025 混寫） |
| v0.6 | 2026-04-04 | 第二輪人工校稿（Q19校稿）：(1) 流程圖改為「sequential 為預設，符合 ADA 2026 Rec 11.9 條件（T2D + UACR ≥100 + eGFR 30–90 + 已用 RASi）者可 simultaneous initiation」，解決「不建議同時啟動」與「可同步起始」的內部矛盾；(2) Finerenone 適應條件補入完整 KDIGO 2024 標準（eGFR >25、血鉀正常、UACR >30、maximum tolerated RASi）；高血鉀保護效益改保守語氣；(3) 加入 FLOW（NEJM 2024，n=3,533）作為 GLP-1 RA 段的核心 RCT anchor（major kidney outcomes HR 0.76，MACE HR 0.82）；GLP-1 RA 臨床建議段同步補入 FLOW；(4) 刪除「CONFIDENCE-2」（無正式已命名 Phase 3 可查核）；修正「RENAL LIFECYCLE」（非 finerenone 整合試驗，刪除）；保留 FIND-CKD NCT05047263 |
| v0.5 | 2026-04-04 | 第一輪人工校稿（Q19校稿）：(1) CONFIDENCE 年份 2024→2025，補入 DOI 10.1056/NEJMoa2410659，補入 180 天 UACR 精確數字（較 finerenone 單用 -29%、較 empagliflozin 單用 -32%）；(2) FIDELITY subgroup 軟化：HR 0.42 vs 0.80 加入「interaction 未達統計顯著，不能詮釋為合用明確優於單用」；高血鉀改為保守描述；LOE A→B；(3) GLP-1 + SGLT2i 拆成兩列：Circulation 2024 meta-analysis（效益不被抵消，LOE A）vs population-based cohort（MACE -30%、serious kidney events -57%，LOE B）；(4) ADA 2026 Rec 11.9 移除 Class IIb 標籤，改為 Grade B，wording 改為「可考慮」；合併 ADA 2025/2026 為一列；(5) ESC 2023 finerenone row 刪除（無法在 focused update 官方文件中核實）；KDIGO 2024 row 補入完整 ns-MRA + GLP-1 RA 表述；(6) 非 T2D CKD 不確定性更新：FIND-CKD NCT05047263 已 Phase 3 completed，改為「待正式發表後解讀」；(7) 移除 AI 草稿警語；Last Updated 更新 2026-04-04 |
| v1.1 | 2026-03-22 | AI 草稿自動更新：加入 ADA 2026 Rec 11.9 |
| v1.0 | 2026-03-17 | AI 自動生成草稿 |

---

## 相關筆記
[Q20 Special Populations](/notes/q20-special-populations)：特殊族群的 SGLT2i 使用（含合併治療情境）
[Q03 Initiation Criteria](/notes/q03-initiation-criteria)：SGLT2i 啟動條件與時機
