...
正確的停藥決策不是「有病就停」，而是根據疾病嚴重度、脫水程度、糖尿病狀態進行個別化評估。同等重要的是確保**症狀緩解後及時重啟**。
...
根據 2025 年的 practical review / guidance（PMID 40247631），對因急性心衰住院且**已 hemodynamically stabilized**、無 ketonemia/ketonuria、非 prolonged fasting、acute phase 已改善者，可考慮住院中早期啟動或延續 SGLT2i：
...
| 版本 | 日期 | 主要變更 |
|------|------|---------|
| v1.5 | 2026-04-03 | 第五輪人工審閱（Q14校稿）：(1) 2022 Perspective row：來源類型精確化，標明「perspective / viewpoint，非 patient cohort 或 RCT」；移除「COVID-19 期間 T2DM」過窄描述，改為「T2DM、HF、CKD + acute illness；主張重新檢視 blanket sick-day stopping policy；low DKA rates」；LOE 降至 C（perspective）；(2) 流程圖 sick-day medication guidance 補齊：「同步停 metformin、NSAID」→「同步 review RASi、diuretics、NSAIDs、metformin，依個別處方調整」，更貼近 AJKD 2023 Delphi 原文 |
| v1.4 | 2026-04-03 | 第四輪人工審閱（Q14校稿）：(1) ADA 2026 row：清化為校稿確認版本，移除⚠️待核實標注，採精確 hospital standards wording（SGLT2i 非住院控糖工具；T2DM+HF 恢復後可 initiate/continue；severe illness/ketonemia/fasting/surgery 避免；3/4 天停藥規則）；(2) UKKA row：整合 symptom-based wording 與⚠️，明確標注「≥2 次」非 UKKA 官方門檻、而是地方 NHS leaflets 的 wording；(3) Clinical Decision 正文：「多機構專家共識」→「practical review / guidance」（PMID 40247631 在 PubMed 標示為 review，非 formal multicenter consensus）；(4) 流程圖第一決策點：「可正常進食飲水」→「評估 acute illness severity：hemodynamics、oral intake、dehydration、ketone/DKA risk、是否 fasting / procedure」，分支標籤補充紅旗情境 |
| v1.3 | 2026-04-03 | 第三輪人工審閱（Q14校稿）：(1) UKKA row 移除「≥2 次」官方門檻暗示，更新為 symptom-based wording（UKKA 本文無固定次數），補入「>48h 仍不適應就醫」；(2) ADA 2026 row 改為精確 hospital standards wording：SGLT2i 非住院控糖工具；T2DM+HF 住院且從 acute illness 恢復可 initiate/continue；severe illness/ketonemia/fasting/surgery 應避免；(3) IES 2025 改標為 Endocrine Abstracts 2026 conference abstract，補入 diabetes 39% 數字；(4) 流程圖「同步停 metformin、NSAID」補 AJKD 2023 Delphi 來源標注；(5) Ongoing trials 加入「current registry search 下的保守推論」說明 |
| v1.2 | 2026-04-03 | 第二輪人工審閱（Q14校稿）：(1) 停藥觸發清單移除「嘔吐 ≥2 次、腹瀉 ≥2 次、≥38.5°C」硬門檻，改為描述性症狀（KDIGO/ADA/UKKA 無固定數字）；(2) 血酮 <0.6 改為非通用規則，限縮至 DM 患者有 DKA risk factors 或症狀者考慮 ketone assessment；(3) 「non-DM eDKA 近乎無」改為 risk appears very low；(4) Key Studies 表拆分 BMJ Open Quality 2025（全文，DM/HF 族群）與 IES2025（conference abstract）兩列；(5) PMID 40247631 標籤從「多機構共識」改為「practical review/guidance」；(6) Uncertainty section 更新：ongoing research 主要在 acute HF / perioperative ketoacidosis / sick-day implementation；restart timing 直接前瞻性試驗仍有限 |
| v1.1 | 2026-04-03 | 第一輪人工審閱（Q14校稿）：(1) KDIGO row 精準化為「prolonged fasting / surgery / critical medical illness」，移除「acute dehydrating illness 一律停藥」延伸句；(2) Endocrine Society 2023 row 移除（來源不準確），改為 FDA 官方標示（手術前 3 天/4 天具體規則）；(3) ADA 2025→2026；(4) 「輕症不必停藥」段落加入 evidence level 標示（2022 perspective，非 RCT 定論）；(5) Acute HF 例外強化「hemodynamically stabilized」限制條件，並說明 KDIGO 「已使用者不必因 eGFR <20 自動停藥」vs 起始門檻的不同語境；(6) Medscape 2026 量化 cutoffs 段落全部移除（vomiting >4/12h、SBP <80、HR +30、72h self-management window 均未核實），改為 AJKD 2023 / UKKA / Diabetes Care 2019 支持的描述性臨床警示徵兆；(7) 衛教數據分層：PMID 41371913 BMJ Open Quality 2025（全文）與 IES2025（conference abstract）分開標示 |
