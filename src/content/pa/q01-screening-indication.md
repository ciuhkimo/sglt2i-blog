...
```mermaid
flowchart TD
    A[HTN 病人於腎臟科門診] --> B{符合任一高風險指標?<br/>resistant HTN / HTN+hypoK /<br/>young-onset <40 / adrenal incidentaloma /<br/>HTN+OSA+風險增強因子 /<br/>unexplained AF or cardioembolic stroke /<br/>sustained BP>150/100 / 家族史}
    B -->|YES| C[強烈建議 ARR<br/>病歷必載適應症]
    B -->|NO| D{新診斷 HTN?}
    D -->|YES| E[建議 ARR 對齊 2025 ES universal<br/>需與病人說明非健保強制]
    D -->|NO| F[繼續標準 HTN 治療<br/>日後出現指標再篩]
    C --> G[抽血前準備:<br/>1. K+ 補到 ≥4.0<br/>2. Minimal washout: 停 MRA + ENaC inhibitor 4 週<br/>3. 其他 diuretics 視臨床懷疑度決定<br/>4. 晨起坐姿採檢]
    E --> G
    G --> H{ARR 結果}
    H -->|Overt biochemical positivity<br/>自發 hypoK + PRA suppressed +<br/>PAC: immunoassay >20 / LC-MS/MS >15 ng/dL| I{考慮手術?}
    I -->|Yes / 可手術 candidate| I1[CT ± AVS<br/>連 Q4<br/>轉介醫學中心]
    I -->|No / 病人拒絕 / 不適合手術| I2[直接啟動 MRA 治療<br/>免 confirmation<br/>連 Q5]
    H -->|ARR 升高但未達 overt| J[Moderately positive<br/>→ confirmation test<br/>連 Q3]
    H -->|ARR 陰性但臨床高度懷疑<br/>有 hypoK 或服干擾藥| K[補 K+、考慮 minimal/full washout<br/>擇日重做 ARR]
    H -->|ARR 陰性、低度懷疑| L[續觀察<br/>日後若 worsening HTN /<br/>新發 hypoK / unexplained AF<br/>再篩]
    J --> M{Confirmation 陽性?}
    M -->|Yes| I
    M -->|No| L
```
