...
quick_answer: "成人 non-DM CKD 若 eGFR≥20 且 UACR≥200，或合併心衰竭，KDIGO 2024 以 1A 強度建議使用 SGLT2i。IgA 腎病變有最直接的 GN subgroup 支持。"
tags:
  - SGLT2i
  - decision-note
  - initiation
...
3. **不要過度外推**
   ...
   - **ANCA-associated vasculitis / lupus nephritis** 目前**不宜寫成已被大型腎臟 outcome trials 充分驗證的族群**
...
其意義是：若 non-DM CKD 患者**同時有 HF**，SGLT2i 的適應性更強，且不是「低風險、可有可無」的族群，而是**高獲益族群**。
...
以下項目可視情況做，但**不應寫成所有 non-DM CKD 啟用前的必要條件**：
- baseline hemoglobin
...
### What to expect
- 啟用初期的 eGFR 小幅下降，通常是**hemodynamic / adaptive** 反應
...
### UACR interpretation
- UACR 下降可作為有用的輔助訊號
- 但目前**沒有單一百分比降幅**可作為一刀切的 success / failure threshold
...
- 是否暫停治療，應依**嚴重度、反覆性、全身狀況、臨床判斷**決定
...
- **Most defensible one-line conclusion**
  **成人 non-DM CKD 應把 SGLT2i 視為 disease-modifying therapy 的核心選項之一；其中 albuminuric CKD 與 HF 為最強適應情境，低 albuminuria 族群可考慮，但 rare immune-mediated GN 不宜過度外推成已充分驗證。**
