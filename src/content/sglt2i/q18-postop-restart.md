...
quick_answer: "術後重啟 SGLT2i 須同時滿足：可正常進食、血流動力學穩定、無酮症，以臨床狀態而非固定天數為依據。"
tags:
  - SGLT2i
  - decision-note
  - restarting
...
### 不建議做法
- **不建議**在 NPO 或僅流質狀態下重啟（最高 eDKA 風險）
- **不建議**以「術後 X 天」作為唯一重啟依據，忽略臨床狀態評估
- **不建議**大型手術後 24-48 小時即重啟（腸麻痺尚未解除）
- **不建議**僅用血糖正常作為「無 eDKA 風險」的依據
...
VA 大型世代研究（N=462,968）提供術後真實世界安全性資料，**支持在符合重啟條件後，避免不必要地過度延遲重啟**（註：此研究為使用者 vs 對照比較，非 restart-timing 直接比較）：
