...
3. **老年（≥80 歲）/ frailty CKD 患者**的安全閾值：此族群在主要 RCT 中代表性不足；整體 RCT evidence 對 orthostatic hypotension 風險偏向無顯著增加，但 volume depletion 風險仍需個別評估；「7 年 pharmacovigilance falls 低 34% vs DPP4i」此一 observational signal 於本次查核中未能核實，已移除
