---
title: "中央性尿崩症（CDI／AVP-D）與 NDI 怎麼分？高血鈉風險、desmopressin 反應與水禁試驗"
description: "中央性尿崩症（CDI，現稱 AVP-deficiency, AVP-D）問題在中樞 AVP 分泌不足；會不會高血鈉取決於病人能不能喝水。整理 CDI 與 NDI 的核心差異、水禁試驗＋desmopressin 的鑑別、臨床警訊與治療時的血鈉監測重點。"
category: "臨床議題"
...
![中央性尿崩症 CDI 與腎性尿崩症 NDI 比較表：CDI 問題在下視丘／後葉腦下垂體 AVP 分泌不足、NDI 問題在腎臟集合管對 AVP 反應不良；比較血中 AVP／copeptin、AQP2、對 desmopressin 反應、典型尿液表現、血鈉與常見原因，以及水禁試驗後尿滲透壓變化](/images/di/cdi-vs-ndi-comparison.webp)
...
```mermaid
flowchart TD
    A[CDI / AVP-D] --> B[AVP 分泌不足]
    B --> C[V2 receptor 訊號不足]
    C --> D[AQP2 無法有效上膜]
    D --> E[Collecting duct 水回收下降]
    E --> F[大量低滲尿 polyuria]
    F --> G{能否喝足夠水?}
    G -->|可以| H[血鈉可正常<br/>但口渴、多喝水]
    G -->|不可以| I[Free water deficit]
    I --> J[高血鈉 hypernatremia]
    B --> K[給 desmopressin]
    K --> L[尿滲透壓上升<br/>尿量下降]
```
