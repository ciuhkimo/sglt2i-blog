---
title: "2026 DKD 四柱療法完整指南：ACEi/ARB、SGLT2i、Finerenone、GLP-1 RA 的排序與整合"
description: "糖尿病腎臟病（DKD）的四柱療法整合指南。涵蓋 ACEi/ARB、SGLT2i、finerenone、GLP-1 RA 的排序邏輯、合併證據、台灣健保實務與 phenotype-based 決策。整合 KDIGO 2024、ADA 2026 與最新 RCT 證據。"
category: "臨床整合"
...
→ 深入閱讀：[Finerenone 決策筆記（11 題）](/finerenone/)
...
- 直接 CKD 硬終點證據目前**最強的是 semaglutide**（FLOW + FDA CKD label）
- 台灣健保：**綁定 HbA1c + 前序治療失敗**，且不可與 SGLT2i 同時給付

→ 深入閱讀：[GLP-1 RA 決策筆記（10 題）](/glp1ra/)
...
- [SGLT2i 決策筆記（20 題）](/sglt2i/) — 啟用到停藥的完整思路
- [GLP-1 RA 決策筆記（10 題）](/glp1ra/) — 以 FLOW 為核心的腎臟定位
- [Finerenone 決策筆記（11 題）](/finerenone/) — 從 DKD 到 HF 的 nonsteroidal MRA
