...
tags:
  ...
  - decision-note
  - initiation
description: "eGFR <30 至透析的 GLP-1 RA 使用：semaglutide、dulaglutide、tirzepatide 依 FDA 標籤不需調整劑量，liraglutide ESRD 經驗有限需保守，exenatide 應避免。PK 可用不等於已證實腎保護。"
quick_answer: "多數 long-acting GLP-1 RA（semaglutide、dulaglutide、tirzepatide）在 eGFR <30 甚至 ESRD 依現行 FDA 標籤不需調整劑量。Liraglutide 標籤不要求調整但 ESRD 經驗有限。Exenatide 在 severe renal impairment / ESRD 應避免。腎臟結局證據以 semaglutide（FLOW）最強，dulaglutide（AWARD-7）在晚期 CKD 最實用。PK 可用不可直接寫成已證實腎保護。"
seo_title: "eGFR <30 能用 GLP-1 RA 嗎？各藥物 PK、證據與安全性完整比較"
---
