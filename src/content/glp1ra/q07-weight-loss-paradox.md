---
question_id: Q07
title: "體重下降在 CKD 病人是好事還是壞事？（obesity paradox）"
...
tags:
  ...
  - decision-note
  - safety
description: "CKD 病人使用 GLP-1 RA 減重的效益與風險評估。Obesity paradox 在觀察性研究存在但 MR 研究不支持因果關係。答案取決於表型：肥胖代謝症候群有利、低 BMI/PEW/frailty 有害。涵蓋 FLOW/SELECT 體重數據、lean mass 疑慮、實務監測框架。"
quick_answer: "Obesity paradox 是統計假象（MR 不支持因果）。肥胖合併代謝異常的 CKD 病人，GLP-1 RA 介入的 intentional weight loss 可能有利（FLOW HR 0.76）；但低 BMI/PEW/frailty 者減重有害。關鍵不是「減了多少」而是「減的是什麼，在什麼表型」。"
seo_title: "CKD 病人減重好不好？Obesity paradox 與 GLP-1 RA 的表型導向決策"
---
