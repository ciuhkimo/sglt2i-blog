...
| **NHIA public documents** | 本次查核可見公開議程與會議文件持續討論 finerenone 健保給付條件，但**未查得已生效之正式收載實施公告**。 | 臨床上目前**不宜假設已可健保給付**。 |
...
1. **成人 T2D + CKD**。
2. 有 **persistent albuminuria**，至少 **UACR ≥30 mg/g**；若 **UACR ≥300 mg/g**，通常更接近高絕對效益 phenotype。
...
1. **已經在 ACEi/ARB + SGLT2i 上，且 albuminuria 仍持續**
   → 這是最典型、最順手的 finerenone 加用情境。

2. **已經有 ACEi/ARB，但尚未用 SGLT2i**
   → 多數情況下仍會盡快把 SGLT2i 放進來；但對 **albuminuria 顯著、risk 高、且接近 CONFIDENCE entry phenotype**（例如 eGFR 30-90、UACR ≥100、已在 ACEi/ARB 上）的患者，**simultaneous initiation** 是合理且有 guideline / trial 支持的做法。

3. **SGLT2i 無法使用或無法耐受**
   → finerenone 仍可在 ACEi/ARB 的基礎上作為 evidence-based add-on；不必因無法使用 SGLT2i 就放棄 finerenone。

4. **ACEi/ARB 無法使用**
   → 目前主要 trial 與 guideline 都是建立在 RAS blockade 之上；若完全無法使用 ACEi/ARB，則 finerenone 的使用較接近 extrapolation，需要 individualized decision 並清楚記錄 rationale。
...
- **Key References**:
  1. KDIGO 2024 CKD Guideline. Kidney Int. 2024;105(4S):S117-S314. PMID: 38490803.
  2. ADA Standards of Care 2026. Diabetes Care. 2026;49(Suppl 1):S246-S260.
  3. FDA Kerendia Prescribing Information. Revised 2025-07.
  4. EMA Kerendia EPAR / SmPC; CHMP positive opinion 2026-01-29.
  5. TFDA Assessment Report: Kerendia 10 mg / 20 mg; approval 2022-07-01.
  6. Bakris GL, et al. N Engl J Med. 2020;383:2219-2229. PMID: 33264825.
  7. Pitt B, et al. N Engl J Med. 2021;385:2252-2263. PMID: 34449181.
  8. Agarwal R, et al. Eur Heart J. 2022;43:474-484. PMID: 35023547.
  9. Rossing P, et al. Diabetes Care. 2022. PMID: 35972218.
