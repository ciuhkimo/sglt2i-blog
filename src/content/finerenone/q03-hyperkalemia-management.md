...
- 正確處理 hyperkalemia 的目的，不只是避免急性不良事件，更是**避免不必要地永久停掉 finerenone，保留其心腎保護效益**。
...
| **KDIGO 2022 / 2024** | 實務上應選擇 **consistently normal K** 的病人 | **1 個月後**再測，之後約 **每 4 個月** | 依 trial-style algorithm：**>5.5 hold，≤5.0 restart 10 mg** |
...
**已驗證的 7 個 baseline covariates** 可組成 **0-12 分**整數分數，推估「新發 K >5.5 mmol/L」風險；model discrimination 為 **C-index 0.732**（derivation）與 **0.721**（validation）。
...
1. 因為擔心 hyperkalemia 就**預設永久不開 finerenone**
2. 把 finerenone 與 **steroidal MRA / 其他 MRA / K-sparing diuretic** 併用
3. 省略**第 4 週 K / eGFR 追蹤**
4. 全面禁止水果與蔬菜
...
- **Key References**:
  1. Agarwal R, et al. Eur Heart J. 2022;43:474-484. PMID: 35023547.
  2. Agarwal R, et al. J Am Soc Nephrol. 2022;33:225-237. PMID: 34732509.
  3. Ferreira JP, et al. Eur Heart J. 2025. PMID: 40259794.
  4. FDA Kerendia PI. 2025. EMA Kerendia SmPC.
