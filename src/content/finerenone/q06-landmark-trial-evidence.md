...
description: "FIDELIO-DKD、FIGARO-DKD 與 FIDELITY 三項 finerenone 試驗的正確解讀：各自回答什麼、不能回答什麼、如何避免常見誤讀。依權威網站、PubMed、ClinicalTrials.gov 查核修訂。"
quick_answer: "FIDELIO-DKD 是腎臟主要終點 RCT（kidney composite HR 0.82）；FIGARO-DKD 是心血管主要終點 RCT（CV composite HR 0.87，HHF HR 0.71）；FIDELITY 是預先規劃的 pooled analysis（不是第三個 RCT）。談腎臟引 FIDELIO，談 CV/HHF 引 FIGARO，談整體引 FIDELITY 但須標明 pooled analysis。"
seo_title: "FIDELIO、FIGARO、FIDELITY 臨床解讀｜Finerenone 證據"
---
...
4. **Non-diabetic CKD**：FIND-CKD pending
5. **Mortality benefit** 尚未穩固建立
